  ...
  en: {
    translation: {
      ...
      rfp: {
        ...
        minimumBudget: 'Budget estimate',
        enterMinimumBudget: 'Enter budget estimate',
        ...
        portfolioLink: 'Link to RFP/Procurement portal',
        mandatoryWalkthrough: 'Mandatory Walkthrough',
  ...
  fr: {
    translation: {
      ...
      sidebar: {
        ...
        allRfps: 'Rechercher Tous les RFPs',
        rfis: 'RFIs',
        reports: 'Rapports',
